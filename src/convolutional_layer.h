...
void cudnn_convolutional_setup(layer *l);
    ...
    void forward_convolutional_layer_gpu_frbmmv(convolutional_layer layer, network net);
    void backward_convolutional_layer_gpu_frbmmv(convolutional_layer layer, network net);
    ...
    void update_convolutional_gpu_sgx_verifies_      (convolutional_layer l, update_args);
    void create_convolutional_snapshot_for_sgx_      (struct layer&, struct network&, uint8_t** out, uint8_t**sha256_out);
#endif
